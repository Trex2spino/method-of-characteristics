...
import engine_inlet.method_of_characteristics.unit_processes as unit_processes 
...
class test_operators(unittest.TestCase):
    ...
    def test_invWall_abv(self):
        ...
        res = unit_processes.inverse_wall(pt1, pt2, pt3, self.gas, self.delta, 0.0001, self.funcs, 'pos')
        expected_res = [0.005211, 0.026063, None, None, 1583.49, 738.39]
    ...
    #     res = unit_processes.symmetry_boundary(pt2, self.gas, self.delta, 0.0001, self.funcs) #running interior operator on single test point
